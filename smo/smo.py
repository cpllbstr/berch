        ...
        if len(queue_direct):
            if queue_direct[0].arrived and not stop:
                ...
                if len(queue_direct):
                    ...
                    car_arr.transit(cur_time + round(-log(1 - random.random())*speed[car_direction],1))
...
while cur_time < 3600:
 ...
 #   print("  future_2: ", future)
    ...
    queue, direction_is_busy, future = scan_phase(queue, direction_is_busy, future, stop, cur_time, speed)
